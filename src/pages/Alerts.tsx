...
export default function Alerts() {
  return (
    <>
      <PageHeader
        title="Alerts"
        description="Inventory, shipment and operational alerts in one place."
        actions={<Button size="sm" variant="outline"><CheckCheck className="mr-1.5 h-4 w-4" /> Mark all as read</Button>}
      />
